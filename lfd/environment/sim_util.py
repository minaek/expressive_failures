...
from lfd.rapprentice import animate_traj, retiming, math_utils as mu, plotting_openrave
...
def sim_full_traj_maybesim(sim_env, full_traj, animate=False, interactive=False, max_cart_vel_trans_traj=.05):
    ...
    transition_traj = retiming.retime_traj(sim_env.robot, dof_inds, transition_traj, max_cart_vel=max_cart_vel_trans_traj)
    ...
    traj = retiming.retime_traj(sim_env.robot, dof_inds, traj) # make the trajectory slow enough for the simulation
